...
Do not give feedback on every possible change, only the most important. Ensure your feedback is brief, concise, accurate, and relevant. Only suggest code changes when you're confident your suggestions are improvements. Use the same programming language as the file under review.
