...
Format the response in a valid JSON format as a list of feedbacks, where the value is an object containing the filename ("fileName"), LOGAF score ("logafScore"), the feedback ("details") and the line number ("line") of the code that you are providing feedback on. The schema of the JSON feedback object must be:
{
  "fileName": {
    "type": "string"
  },
