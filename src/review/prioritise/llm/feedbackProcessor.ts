...
const createSummary = async (model: AIModel, feedbacks: IFeedback[]): Promise<string> => {
  const finalPrompt = completionPrompt.replace("{feedback}", JSON.stringify(feedbacks))
