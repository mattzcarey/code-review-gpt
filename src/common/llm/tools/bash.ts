...
export const bashTool = tool({
  description:
    'Execute a bash command and get its output. Use this tool to run command such as git commands to step through changes made to get to the current state of the codebase or to run tests or build scripts.',
  parameters: z.object({
